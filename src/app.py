...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice fundamentals and play weekly scrimmages",
    ...
    "Science Olympiad": {
        "description": "Prepare for science challenges and team competitions",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Ensure participant is currently registered
